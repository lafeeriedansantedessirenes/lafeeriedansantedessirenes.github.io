...
En gros l'API d'Instagram n'est plus accessible gratuitement donc impossible d'utiliser un shortcode ici. Merci Facebook, merci Mark.

On va tenter avec Vimeo alors. 

- La meilleure vidéo sur Vimeo :

{{< vimeo 165213129 >}}

Voilà, ça, ça marche.

Bref, j'arrête d'écrire et j'arrête de bosser. La bise